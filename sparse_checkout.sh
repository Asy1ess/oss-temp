...
git_folder_location='/Users/Admin/conda'   #replace with the local root folder location where you want to create the project folder
project_name=ossmlopstest   #replace with your project name
github_org_name=asy1ess   #replace with your github org name
